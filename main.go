...
import (
	...
	"github.com/example/marklogic-operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e6660515.marklogic.com",
	...
	if err = (&controllers.MarklogicServerReconciler{
	...
	if err = (&controllers.MarklogicClusterReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
