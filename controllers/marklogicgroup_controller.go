...
// MarklogicServerReconciler reconciles a MarklogicGroup object
type MarklogicServerReconciler struct {
	client.Client
...
//+kubebuilder:rbac:groups=core,resources=pods;service,verbs=get;list;watch
...
func (r *MarklogicServerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *MarklogicServerReconciler) SetupWithManager(mgr ctrl.Manager) error {

	builder := ctrl.NewControllerManagedBy(mgr).
		Named("marklogicgroup-controller").
		For(&operatorv1alpha1.MarklogicGroup{}).
