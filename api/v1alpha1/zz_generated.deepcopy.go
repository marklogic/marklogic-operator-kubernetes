...
func (in *HAProxyConfig) DeepCopyInto(out *HAProxyConfig) {
	*out = *in
	if in.DefaultAppServers != nil {
		in, out := &in.DefaultAppServers, &out.DefaultAppServers
		*out = make([]AppServers, len(*in))
		copy(*out, *in)
	}
	if in.AdditionalAppServers != nil {
		in, out := &in.AdditionalAppServers, &out.AdditionalAppServers
		*out = make([]AppServers, len(*in))
		copy(*out, *in)
	}
